...
// It calculates the start date based on the time range ("week", "month", "year") and fetches user statistics from the database.
// The function returns a map containing the user data for each relevant date.
//
// Parameters:
