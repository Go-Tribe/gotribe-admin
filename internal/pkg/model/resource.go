...
type Resource struct {
	...
	FileExtension string `gorm:"not null;type:varchar(10);not null;comment:文件拓展" json:"file_extension"`
	FileType      uint   `gorm:"type:smallint;not null;default:1;comment:资源类形，1-图片;2-文件;3-视频;4-音频" json:"fileType"`
