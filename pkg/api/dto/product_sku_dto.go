...
func toProductSkuDto(productSku *model.ProductSku) ProductSkuDto {
	...
	return ProductSkuDto{
		...
		CostPrice:     util.MoneyUtil.CentsToYuan(productSku.CostPrice),
		MarketPrice:   util.MoneyUtil.CentsToYuan(productSku.MarketPrice),
		UnitPrice:     util.MoneyUtil.CentsToYuan(productSku.UnitPrice),
		UnitPoint:     util.MoneyUtil.CentsToYuan(productSku.UnitPoint),
